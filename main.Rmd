...
woody_gt15$taxonID <- factor(woody_gt15$taxonID)
woody_gt15$growthForm <- factor(woody_gt15$growthForm)
woody_gt15$plantStatus <- factor(woody_gt15$plantStatus)

# further filter data drame for only columns of interest
woody_features <- woody_gt15 %>% 
          select(growthForm, 
                 plantStatus, 
                 height, 
                 maxCrownDiameter, 
...
# train
train=sample(1:nrow(woody_features),200)
